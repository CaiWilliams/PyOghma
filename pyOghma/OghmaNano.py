...
from pyOghma import Optical
from pyOghma import Sims
from pyOghma import Thermal
from pyOghma import Server
from pyOghma import Epitaxy

class OghmaNano:
    def __init__(self):
        self.results_dir = self.check_results()
        self.Optical = Optical.Optical()
        self.Sims = Sims.Sims()
        self.Thermal = Thermal.Thermal()
        self.Server = Server.Server()
        self.Epitaxy = Epitaxy.Epitaxy()
