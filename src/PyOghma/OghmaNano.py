"""
This module provides functionality for managing and executing simulations in the OghmaNano framework. 
It supports setting up experiments, configuring variables, cloning and loading simulations, and 
managing subcomponents for optical, thermal, and machine learning tasks. The module also facilitates 
job execution and cleanup of simulation results.
"""
